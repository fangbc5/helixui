...
pub fn t(key: &str) -> String {
    ...
    let text = match (lang, key) {
        ...
        (Language::ZhCN, "component.collapsible") => "折叠面板 Collapsible",
        (Language::EnUS, "component.collapsible") => "Collapsible",
        (Language::ZhCN, "component.divider") => "分割线 Divider",
        (Language::EnUS, "component.divider") => "Divider",
        (Language::ZhCN, "component.dropdown") => "下拉菜单 Dropdown",
        (Language::EnUS, "component.dropdown") => "Dropdown",
        ...
        (Language::ZhCN, "component.watermark") => "水印 Watermark",
        (Language::EnUS, "component.watermark") => "Watermark",
        (Language::ZhCN, "component.float-button") => "浮动按钮 FloatButton",
